                ...
                <div className='row'>
                    <div className='col-md-8'>
                        <div className='stdsection'>
                            <div className='row' style={{ padding: '15px 0 2px 0' }}>
                                <div className='col-md-2 verticalcenteralignrow'>
                                    <div className={Styles.Qtxt}>Questions</div>
                                </div>
                                <div className='col-md-9 verticalcenteralignrow'>
                                    <Carousel
                                        breakPoints={this.state.breakPoints}
                                        pagination={false}
                                        renderArrow = {({ type, onClick }) => {
                                            const pointer = type === consts.PREV ? <FontAwesomeIcon icon={faChevronCircleLeft} style={{ fontSize: '23px', color: 'black', position: 'absolute', right: '-10px', marginTop: '10px' }} />  
                                            : <FontAwesomeIcon icon={faChevronCircleRight} style={{ fontSize: '23px', color: 'black', position: 'absolute', right: '-35px', marginTop: '10px' }} /> 
